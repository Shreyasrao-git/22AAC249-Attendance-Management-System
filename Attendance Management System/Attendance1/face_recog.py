...
target_image = fr.load_image_file("F:/Attendance Management System/Attendance3/abhishekgroup.jpeg")
...
def sms(absentees_numbers):
    sid = "AC677ae0beaf83944f7cb18d5098eb0709"
    auth_token = "8d4bd3f038a925979fa8fc253bb3245f"
    client = Client(sid, auth_token)
    for phno in absentees_numbers:
        number=''.join(phno)
        client.messages.create(body='Your ward is absent',from_='+12283640932',to=number)
